...
class FirebaseAuthentication  {
 ...
 FirebaseAuthentication(){_firebaseAuth = FirebaseAuth.instance;}
  ...
  if (e.code == 'user-not-found') {
    _sankeMasseg(context ,"user not found, try change the email address :/");
  ...
  Future<User> register(String email, String password,BuildContext context) async {
    try {
      ...
      if (e.code == 'email-already-in-use') {
        _sankeMasseg(context ,"email is already in use try anther one or sing in!");
      }
    }
  }
